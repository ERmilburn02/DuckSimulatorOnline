  ...
  return (
    <>
      <div className="grid grid-cols-level-leaderboard-mobile md:grid-cols-level-leaderboard grid-rows-2 text-center items-center justify-items-center w-full h-24 md:h-36 my-4">
        <div className="row-span-2 font-bold text-xl md:text-5xl m-1">#</div>
        ...
        <div className="text-md md:text-3xl">Loading level...</div>
        <div className="text-md md:text-3xl">Loading XP...</div>
        <div className="text-md md:text-3xl">Loading messages...</div>
      </div>
    </>
  );
}
